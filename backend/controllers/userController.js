...
if (!process.env.STRIPE_SECRET_KEY) {
    console.warn("Warning: STRIPE_SECRET_KEY is not set. Stripe payment APIs will be disabled.")
}
...
if (!process.env.RAZORPAY_KEY_ID || !process.env.RAZORPAY_KEY_SECRET) {
    console.warn("Warning: Razorpay keys are not set. Razorpay payment APIs will be disabled.")
}
